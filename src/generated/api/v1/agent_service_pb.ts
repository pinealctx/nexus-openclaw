...
export type GetSelfAgentResponse = Message<"api.v1.GetSelfAgentResponse"> & {
  ...
  /**
   * Agent profile (developer-visible fields from agent_profiles).
   *
