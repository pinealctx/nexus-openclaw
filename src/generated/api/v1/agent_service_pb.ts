...
export const file_api_v1_agent_service: GenFile = /*@__PURE__*/
  fileDesc("", [file_buf_validate_validate, file_shared_v1_agent, file_shared_v1_options]);
 ...
 *
 * @generated from message api.v1.UpdateAgentSelfConfigRequest
 */
export type UpdateAgentSelfConfigRequest = Message<"api.v1.UpdateAgentSelfConfigRequest"> & {
  /**
   * Slash commands (replaces existing, max 100). When set, replaces all
   * commands; omit to leave commands unchanged.
   *
   * @generated from field: optional shared.v1.AgentCommandList commands = 1;
   */
  commands?: AgentCommandList;
   ...
   * Event delivery mode.
   *
   * @generated from field: optional shared.v1.AgentDeliveryMode delivery_mode = 2;
   */
  deliveryMode?: AgentDeliveryMode;
...
/**
 * Describes the message api.v1.UpdateAgentSelfConfigRequest.
 * Use `create(UpdateAgentSelfConfigRequestSchema)` to create a new message.
 */
export const UpdateAgentSelfConfigRequestSchema: GenMessage<UpdateAgentSelfConfigRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_agent_service, 22);

/**
 * UpdateAgentSelfConfigResponse is returned after agent self-config is updated.
 *
 * @generated from message api.v1.UpdateAgentSelfConfigResponse
 */
export type UpdateAgentSelfConfigResponse = Message<"api.v1.UpdateAgentSelfConfigResponse"> & {
};

/**
 * Describes the message api.v1.UpdateAgentSelfConfigResponse.
 * Use `create(UpdateAgentSelfConfigResponseSchema)` to create a new message.
 */
export const UpdateAgentSelfConfigResponseSchema: GenMessage<UpdateAgentSelfConfigResponse> = /*@__PURE__*/
  messageDesc(file_api_v1_agent_service, 23);
...
export const AgentService: GenService<{
   ...
   *   - INVALID_ARGUMENT: Invalid field values or webhook URL.
   *
   * @generated from rpc api.v1.AgentService.UpdateAgentSelfConfig
   */
  updateAgentSelfConfig: {
    methodKind: "unary";
    input: typeof UpdateAgentSelfConfigRequestSchema;
    output: typeof UpdateAgentSelfConfigResponseSchema;
  },
}> = /*@__PURE__*/
